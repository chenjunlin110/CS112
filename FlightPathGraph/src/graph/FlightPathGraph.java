...
public class FlightPathGraph {
    ...
    public void addEdge(String departure, String arrival) {
        // WRITE YOUR CODE HERE
        if (Objects.equals(departure, arrival)) return;
        City currentCity = null;
         for (City city : flightPaths) {
             if (city.city.equals(departure)) {
                 currentCity = city;
                 break;
             }
         }
         ...
         while (currentCity != null) {
             if (currentCity.city.equals(arrival)) {return;}
             prevCity = currentCity;
             currentCity = currentCity.next;
         }
         prevCity.next = new City(arrival);
    }
    ...
    public void removeEdge(String departure, String arrival) {
        ...
        while (!currentCity.city.equals(arrival) && currentCity != null) {
        ...
        if (previousCity != null) {
            ...
            for (City flightPath : flightPaths) {
                if (flightPath.city.equals(departure)) {
                    flightPath.next = currentCity.next;
                    break;
                }
            }
        }
