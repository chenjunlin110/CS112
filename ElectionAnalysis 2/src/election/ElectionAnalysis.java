...
public class ElectionAnalysis {
    ...
    public void readElections(String file) {
        ...
        while (StdIn.hasNextLine()) {
          ...
          do {
            ...
            currStateNode = currStateNode.getNext();
          ...
          if (electionfound) {
            ...
            if (currStateNode.getElections() == null) {
    ...
    public int averageVotes(int year, String stateName) {
        ...
        StateNode curStateNode = cuYearNode.getStates();
        StateNode starStateNode = curStateNode;
        ...
        while (curStateNode != starStateNode);
        ...
        ElectionNode curElectionNode = curStateNode.getElections();
        while (curElectionNode != null) {
          totalelections += 1;

          totalvotes += curElectionNode.getVotes();
          curElectionNode = curElectionNode.getNext();
        }
    ...
    public String candidatesParty(String candidateName) {
          ...
          while (cuYearNode != null) {
            ...
            do {
              ...
              while (curElectionNode != null) {
                if (curElectionNode.getCandidates().contains(candidateName)) {
                  String party = curElectionNode.getParty(candidateName);
                  if (oldestParty == null) {
                    oldestParty = party;
                  }
                }
